...
// Set variables in tree
 Double_t       B_D_FD;
   ...
   TFile *newfile = new TFile("../../data/Data2016_Strip28r1_MagUpsmall100withcuts.root","recreate"); // The 300 after small refers to the fact that the tree was decreased in size by a factor of 300
   TTree *newtree = oldtree->CloneTree(0);

for (Long64_t i=0;i<(nentries/100); i++) {
      oldtree->GetEntry(i);
